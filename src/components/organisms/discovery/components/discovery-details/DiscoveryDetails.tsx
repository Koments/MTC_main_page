...
import {DiscoveryDetailsContainer} from "./DiscoveryDetails.module";

export const DiscoveryDetails = () => {
    return (
            <DiscoveryDetailsContainer>
                <div className="details__block">
                    <div className="discovery__subtitle">
                        <p>Quality Craftmanship from build to delivery</p>
                    </div>
                    <div className="discovery__title">
                    ...
                    <div className="discovery__btn-container">
